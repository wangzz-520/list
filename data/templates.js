...
const templates = [
  ...
  },
  {
    ...
    groups: [
      { id: 'identity', name: '身份证件', items: ['身份证', '户口本', '居住证', '驾驶证', '护照/通行证', '社保卡', '学生证/工作证', '证件照'] },
      { id: 'copies', name: '复印扫描', items: ['身份证正反面复印件', '户口本首页本人页复印件', '电子证件照', '学历/资格证书复印件', '银行卡复印件', '材料扫描件', 'U 盘/网盘备份'] },
      { id: 'submit', name: '提交确认', items: ['办理地址', '预约截图', '申请表', '照片回执', '原件是否归还', '缴费凭证', '快递单号', '经办人电话'] }
    ]
  },
  {
    id: 'travel_basic',
  ...
  },
  {
    ...
    icon: '🧢',
    heat: 74,
    description: '周末带孩子去公园、博物馆、短途游玩时使用，轻装但不漏关键物品。',
    groups: [
      { id: 'before', name: '出发前确认', items: ['确认目的地开放时间', '预约门票/停车', '查看天气', '规划交通路线', '告知家人行程', '确认返程时间'] },
      { id: 'kids', name: '孩子用品', items: ['水杯', '纸巾湿巾', '备用衣物', '帽子', '小零食', '防晒/驱蚊', '常用小药品', '喜欢的小玩具'] },
      { id: 'parent', name: '家长随身', items: ['手机', '充电宝', '身份证', '少量现金', '垃圾袋', '雨伞', '拍照设备', '紧急联系人'] }
    ]
  },
  {
    id: 'family_emergency',
